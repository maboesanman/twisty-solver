use crate::{cube_ops::{cube_move::DominoMove, cube_sym::DominoSymmetry}, kociemba::coords::coords::EEdgePermRawCoord, permutation_math::permutation::Permutation};
...
impl EEdgePerm {
    ...
    pub const fn domino_conjugate(self, sym: DominoSymmetry) -> Self {
        let perm = crate::cube_ops::cube_sym::EDGE_PERM_LOOKUP[sym.0 as usize].split().2;
