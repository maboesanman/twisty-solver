...
use kociemba::tables::{
    ...
    move_table_sym_phase_1_edge::load_phase_1_edge_move_table,
...
pub fn main() -> Result<()> {
    ...
    let t2 = load_edge_orient_move_table("edge_orient_move_table.dat")?;
    let t3 = load_edge_grouping_move_table("edge_grouping_move_table.dat")?;
