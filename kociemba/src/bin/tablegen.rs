use anyhow::Result;
// use kociemba::tables::{
//     move_raw_corner_orient::load, move_table_raw_corner_perm::load_corner_perm_move_table, move_table_raw_e_edge_perm::load_e_edge_perm_move_table, move_raw_edge_group_flip::load, move_table_raw_ud_edge_perm::load_ud_edge_perm_move_table, move_table_sym_edge_group_flip::load, move_table_sym_corner_perm::load_phase_2_corner_sym_move_table, pruning_table_phase_1_working::load_phase_1_pruning_table, sym_lookup_phase_1_edge::load, sym_lookup_phase_2_corner::load_phase_2_corner_sym_lookup_table
// };

pub fn main() -> Result<()> {
    // let phase_1_move_edge_raw_table =
    //     load("edge_group_and_orient_move_table.dat")?;
    // let phase_1_move_corner_raw_table =
    //     load("corner_orient_move_table.dat")?;
    // let phase_1_lookup_edge_sym_table = load(
